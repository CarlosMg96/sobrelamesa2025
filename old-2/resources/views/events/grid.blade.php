...
@section('body')
    ...
    @section('content')
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="mb-3">
                    <h5 class="card-title">Juntas IBA <span class="text-muted fw-normal ms-2">(834)</span></h5>
                </div>
            </div>
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                    ...
                    <div>
                        <a href="#" data-bs-toggle="modal" data-bs-target=".add-new" class="btn btn-primary"><i
                                class="bx bx-plus me-1"></i> Agregar Nuevo</a>
                    </div>
                    <div class="dropdown">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-1 ms-1">
                                <h5 class="font-size-16 mb-1"><a href="#" class="text-body">{{ $event->lawfirm }}</a></h5>
                                <span class="badge bg-warning-subtle text-warning mb-0">{{ $event->country }}</span>
                            </div>
                        </div>
