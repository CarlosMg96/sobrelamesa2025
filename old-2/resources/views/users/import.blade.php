            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('users') }}">Directorio</a></li>
                ...
                <div class="card-body">
                    <form id="import-form" action="{{ route('users.import') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-4 d-flex justify-content-between">
                            ...
                            <div>
                                {{-- <a href="{{ route('users.template') }}" class="btn btn-outline-info me-2" target="_blank">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center py-4">
                    ...
                    <button type="button" class="btn btn-warning" onclick="window.location.href='{{ route('users') }}'">
                        Ver usuarios
                    </button>
                </div>
            </div>
