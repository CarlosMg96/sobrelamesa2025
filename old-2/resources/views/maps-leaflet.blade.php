...
@section('css')
    <!-- leaflet Css -->
    <link href="{{ URL::asset('libs/leaflet/leaflet.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('page-title')
    Leaflet Maps
@endsection
@section('body')
    ...
    @section('scripts')
        <!-- leaflet plugin -->
        <script src="{{ URL::asset('libs/leaflet/leaflet.js') }}"></script>

        <!-- leaflet map.init -->
        <script src="{{ URL::asset('js/pages/leaflet-us-states.js') }}"></script>
        <script src="{{ URL::asset('js/pages/leaflet-map.init.js') }}"></script>
        <!-- App js -->
