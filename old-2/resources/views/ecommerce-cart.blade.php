                            ...
                            <table class="table align-middle mb-0 table-nowrap mb-0">
                                ...
                                <thead class="table-light">
                                    <tr>
                                        <th>Product</th>
                                        <th>Product Name</th>
                                        <th  nonce="newN0nc3ForS3cur1ty" style="width: 120px;">Price</th>
                                        <th>Quantity</th>
                                        <th>Total</th>
                                        <th>Action</th>
                                    </tr>
                                ...
                                <tbody>
                                    <tr>
                                        <th><img src="{{ URL::asset('images/product/img-1.png') }}" alt=""
                                    ...
                                    <tr>
                                        <th><img src="{{ URL::asset('images/product/img-2.png') }}" alt=""
                                                class="avatar-lg rounded p-1"></th>
                                        <td>
                                            <div>
                                                <h5 class="text-truncate font-size-16"><a
                                    ...
                                    <tr>
                                        <th><img src="{{ URL::asset('images/product/img-5.png') }}" alt=""
                                                class="avatar-lg rounded p-1"></th>
                                        <td>
                                            <div>
                                                <h5 class="text-truncate font-size-16"><a
                                    ...
                                    <tr>
                                        <th><img src="{{ URL::asset('images/product/img-7.png') }}" alt=""
                                                class="avatar-lg rounded p-1"></th>
                                        <td>
                                            <div>
                                                <h5 class="text-truncate font-size-16"><a
                                    ...
                                    <tr>
                                        <th><img src="{{ URL::asset('images/product/img-8.png') }}" alt=""
                                                class="avatar-lg rounded p-1"></th>
                                        <td>
                                            <div>
                                                <h5 class="text-truncate font-size-16"><a
