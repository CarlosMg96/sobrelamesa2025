<header id="page-topbar" class="isvertical-topbar">
    <div class="navbar-header">
        <div class="d-flex w-100 d-md-none">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="navbar-brand-box me-2">
                    <a href="/" class="logo logo-dark">
                        <span class="logo-sm">
                            <h3 nonce="newN0nc3ForS3cur1ty"  nonce="newN0nc3ForS3cur1ty" style="font-size: 1.5rem; font-family: 'Gelasio', serif;">Galicia</h3>
                        </span>
                        <span class="logo-lg">
                            <h3 nonce="newN0nc3ForS3cur1ty"  nonce="newN0nc3ForS3cur1ty" style="font-size: 1.5rem; font-family: 'Gelasio', serif;">Galicia</h3>
                        </span>
                    ...
                    <a href="/" class="logo logo-light">
                        <span class="logo-sm">
                            <h3 nonce="newN0nc3ForS3cur1ty"  nonce="newN0nc3ForS3cur1ty" style="font-size: 1.5rem; font-family: 'Gelasio', serif; color: #fff;">Galicia</h3>
                        </span>
                        <span class="logo-lg">
                            <h3 nonce="newN0nc3ForS3cur1ty"  nonce="newN0nc3ForS3cur1ty" style="font-size: 1.5rem; font-family: 'Gelasio', serif; color: #fff;">Galicia</h3>
                        </span>
                ...
                <!-- BOTÓN MENÚ -->
                <button type="button" class="btn btn-sm px-2 font-size-24 header-item waves-effect vertical-menu-btn">
            ...
            <div class="d-flex justify-content-end ms-auto">
                ...
                <!-- <div class="me-2">
                    ...
                    target="_blank" 
                    class="btn btn-sm px-3 font-size-16 header-item d-flex align-items-center">
                ...
                <!-- Botón de Logout -->
                <div>
                    <a href="#" id="logout-link" class="btn btn-sm px-3 font-size-16 header-item d-flex align-items-center">
        ...
        <div class="d-flex d-sm-none d-md-block">
            <!-- PAGE TITLE --> 
            <div class="page-title-box d-none d-md-block ms-3">
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon btn-search d-none" data-bs-toggle="modal"
                    aria-haspopup="true" data-bs-target="#myModal">
                ...
                {{-- <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal">Standard modal</button> --}}
            </div>

            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon d-none" id="page-header-notifications-dropdown-v"
                ...
                <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end p-0"
                    ...
                    <div data-simplebar nonce="newN0nc3ForS3cur1ty"  nonce="newN0nc3ForS3cur1ty" style="max-height: 250px;">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    ...
                    <a class="dropdown-item" href="javascript:void();"
                       id="logout-link-dropdown"
                            class="mdi mdi-logout text-muted font-size-16 align-middle me-2"></i> <span
                            class="align-middle">Logout</span></a>
                            <form id="logout-form-dropdown" action="{{ route('logout') }}" method="POST" nonce="newN0nc3ForS3cur1ty"  nonce="newN0nc3ForS3cur1ty" style="display: none;">
                        @csrf
                    </form>
                </div>
            </div>
...
<script nonce="newN0nc3ForS3cur1ty">
    ...
    document.getElementById('logout-link-dropdown').addEventListener('click', function(e) {
        e.preventDefault();
