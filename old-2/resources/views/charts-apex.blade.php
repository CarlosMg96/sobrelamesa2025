...
@section('body')
    ...
    @section('scripts')
        ...
        <script src="https://apexcharts.com/samples/assets/stock-prices.js" integrity="sha384-vQyZyziP4g6FNuE6ij6O5Xfvc7u4GwxMPZkO4Lt/j2WkkjAsTV2or3Im7aQyTn+8" crossorigin="anonymous"></script>

        <!-- for basic area chart -->
        <script src="https://apexcharts.com/samples/assets/stock-prices.js" integrity="sha384-vQyZyziP4g6FNuE6ij6O5Xfvc7u4GwxMPZkO4Lt/j2WkkjAsTV2or3Im7aQyTn+8" crossorigin="anonymous"></script>
        <!-- for github style chart -->
        <script src="https://apexcharts.com/samples/assets/github-data.js" integrity="sha384-u1KUgNRV+KfcE9mYyyJJeOipcNk6BdJkAuZhwEsxZW4tCwAeO/di6ZvVcgmW8Jpq" crossorigin="anonymous"></script>
        <!-- for irregular timeseries chart -->
        <script src="https://apexcharts.com/samples/assets/irregular-data-series.js" integrity="sha384-cO/1tBuEEKAbcsjh6c03XoGOcPoR9KGgk9PSFcdwbyUvMA5+gVHfJYaNPcIF2tNa" crossorigin="anonymous"></script>
        <!-- <script src="{{ URL::asset('libs/moment/moment.js') }}"></script> -->

        <!-- Candlestick  -->
        <script src="https://apexcharts.com/samples/assets/ohlc.js" integrity="sha384-+mbV2IY1Zk/X1p/nWllGySJSUN8uMs+gUAN10Or95UBH0fpj6GfKgPmgC5EXieXG" crossorigin="anonymous"></script>
        <!-- for Category x-axis chart -->
        <script src="https://cdnjs.cloudflare.com/ajax/libs/dayjs/1.8.17/dayjs.min.js" integrity="sha384-+mbV2IY1Zk/X1p/nWllGySJSUN8uMs+gUAN10Or95UBH0fpj6GfKgPmgC5EXieXG" crossorigin="anonymous"></script>
