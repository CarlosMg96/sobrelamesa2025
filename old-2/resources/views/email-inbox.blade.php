                                ...
                                <div class="mail-list">
                                    <a href="javascript: void(0);" class="d-flex align-items-start border-bottom">
                                        <img class="flex-shrink-0 me-3 rounded-circle"
                                            src="{{ URL::asset('images/users/avatar-2.jpg') }}" alt="Generic placeholder image"
                                            height="36">
                                    ...
                                    <a href="javascript: void(0);" class="d-flex align-items-start border-bottom">
                                        <img class="flex-shrink-0 me-3 rounded-circle"
                                            src="{{ URL::asset('images/users/avatar-3.jpg') }}" alt="Generic placeholder image"
                                            height="36">
                                        <div class="flex-grow-1 chat-user-box">
                                    ...
                                    <a href="javascript: void(0);" class="d-flex align-items-start border-bottom">
                                        <img class="flex-shrink-0 me-3 rounded-circle"
                                            src="{{ URL::asset('images/users/avatar-4.jpg') }}" alt="Generic placeholder image"
                                            height="36">
                                        <div class="flex-grow-1 chat-user-box">
                                    ...
                                    <a href="javascript: void(0);" class="d-flex align-items-start border-bottom">
                                        <img class="flex-shrink-0 me-3 rounded-circle"
                                            src="{{ URL::asset('images/users/avatar-6.jpg') }}" alt="Generic placeholder image"
                                            height="36">
                                        <div class="flex-grow-1 chat-user-box">
