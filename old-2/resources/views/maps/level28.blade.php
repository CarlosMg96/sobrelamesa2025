        ...
        <div id="floor-contentZoom" class="position-relative w-100 level-floor-content">
            <div class="svg-zoom-container level-svg-container">
                <div class="svg-container" id="svgContainer">
                    <object id="planoPiso28" data="{{ URL::asset('images/svgMaps/Piso_28_(22Ago25_12pm).svg?v=1') }}"
...
@push('scripts')
    ...
    <script nonce="newN0nc3ForS3cur1ty" >
        ...
        if (typeof window.seccionesPiso28 === 'undefined') {
            window.seccionesPiso28 = [];
        }

        // Configuración de las áreas del mapa
        window.seccionesPiso28 = window.seccionesPiso28.concat([{
                id: 'p28-1',
                code: 'A1',
                nombre: 'Sala 1 (18p)',
                icono: ''
            },
            {
                id: 'p28-2',
                code: 'A2',
                nombre: 'Sala de juntas (6p)',
                icono: ''
            },
            {
                id: 'p28-3',
                code: 'A3',
                nombre: 'Sala de juntas (8p)',
                icono: ''
            },
            {
                id: 'p28-4',
                code: 'A4',
                nombre: 'Sala de juntas (10p)',
                icono: ''
            },
            {
                id: 'p28-5',
                code: 'A5',
                nombre: 'Oficina clientes',
                icono: ''
            },
            {
                id: 'p28-6',
            ...
            },
            {
                id: 'p28-11',
                code: 'A11',
                nombre: 'Sala de juntas (18p)',
                icono: ''
            },
            {
                id: 'p28-12',
                code: 'A12',
                nombre: 'Sala de ideación',
                icono: ''
            },
            {
                id: 'p28-13',
                code: 'A13',
                nombre: 'Town Hall y Lounge (6p)',
                icono: ''
            },
            {
                id: 'p28-14',
        ...
        function loadAndInitializeSVG() {
            ...
            const svgObject = document.getElementById('planoPiso28');
            ...
            svgObject.addEventListener('load', function() {
                ...
                if (typeof window.seccionesPiso28 !== 'undefined' && Array.isArray(window.seccionesPiso28)) {
                    // console.log('Inicializando secciones desde seccionesPiso28. Total:', window.seccionesPiso28
                       // .length);
                    window.secciones = [...window.seccionesPiso28];
                    ...
                    console.error('No se encontraron secciones en window.seccionesPiso28');
                }
            });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setTimeout(() => {
                if (typeof window.seccionesPiso28 !== 'undefined' && Array.isArray(window
                        .seccionesPiso28)) {
                    window.secciones = [...window.seccionesPiso28];
                    if (typeof window.cargarSecciones === 'function') {
                        window.cargarSecciones();
        ...
        function setupAreaClickHandlers(svgDocument, retryCount = 0) {
            ...
            // Asegurarse de que seccionesPiso28 existe
            if (!window.seccionesPiso28 || !Array.isArray(window.seccionesPiso28)) {
                console.error('seccionesPiso28 no está definido o no es un array');
                return;
            }

            window.seccionesPiso28.forEach(section => {
        ...
        function initMapAreas(svgDocument) {
            ...
            seccionesPiso28.forEach(section => {
                const area = svgDocument.getElementById(section.id);
                if (area) {
        ...
        window.resaltarArea = function(areaId, retryCount = 0, showModal = true) {
            ...
            try {
                ...
                const areas = svgDoc.querySelectorAll('[id^="p28-"]');
                areas.forEach(a => {
                    if (a.classList) {
                ...
                const seccion = window.seccionesPiso28 ? window.seccionesPiso28.find(s => s.id === areaId) : null;
