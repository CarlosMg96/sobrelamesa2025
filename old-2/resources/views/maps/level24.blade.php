        ...
        <div id="floor-contentZoom" class="position-relative w-100 level-floor-content">
            <div class="svg-zoom-container level-svg-container">
                <div class="svg-container" id="svgContainer">
                    <object id="planoPiso24" data="{{ URL::asset('images/svgMaps/Piso_24_(22Ago25_12pm).svg?v=1') }}"
...
@push('scripts')
    ...
    <script nonce="newN0nc3ForS3cur1ty" >
        ...
        if (typeof window.seccionesPiso24 === 'undefined') {
            window.seccionesPiso24 = [];
        }

        // Configuración de las áreas del mapa
        window.seccionesPiso24 = window.seccionesPiso24.concat([{
                id: 'p24-1',
                code: 'A1',
                nombre: 'Terraza',
                icono: ''
        ...
        function loadAndInitializeSVG() {
            ...
            const svgObject = document.getElementById('planoPiso24');
            ...
            svgObject.addEventListener('load', function() {
                ...
                if (typeof window.seccionesPiso24 !== 'undefined' && Array.isArray(window.seccionesPiso24)) {
                    // console.log('Inicializando secciones desde seccionesPiso24. Total:', window.seccionesPiso24
                        // .length);
                    window.secciones = [...window.seccionesPiso24];
                    ...
                    // console.error('No se encontraron secciones en window.seccionesPiso24');
                }
            });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setTimeout(() => {
                if (typeof window.seccionesPiso24 !== 'undefined' && Array.isArray(window
                        .seccionesPiso24)) {
                    window.secciones = [...window.seccionesPiso24];
                    if (typeof window.cargarSecciones === 'function') {
                        window.cargarSecciones();
        ...
        function setupAreaClickHandlers(svgDocument, retryCount = 0) {
            ...
            // Asegurarse de que seccionesPiso24 existe
            if (!window.seccionesPiso24 || !Array.isArray(window.seccionesPiso24)) {
                console.error('seccionesPiso24 no está definido o no es un array');
                return;
            }

            window.seccionesPiso24.forEach(section => {
        ...
        function initMapAreas(svgDocument) {
            ...
            seccionesPiso24.forEach(section => {
                const area = svgDocument.getElementById(section.id);
                if (area) {
        ...
        window.resaltarArea = function(areaId, retryCount = 0, showModal = true) {
            ...
            try {
                ...
                const areas = svgDoc.querySelectorAll('[id^="p24-"]');
                areas.forEach(a => {
                    if (a.classList) {
                ...
                const seccion = window.seccionesPiso24 ? window.seccionesPiso24.find(s => s.id === areaId) : null;
