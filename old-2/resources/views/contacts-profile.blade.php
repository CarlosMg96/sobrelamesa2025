                ...
                <div class="card">
                    <div class="card-body p-0">
                        <div class="user-profile-img">
                            <img src="{{ URL::asset('images/pattern-bg.jpg') }}" class="profile-img profile-foreground-img rounded-top"
                                 nonce="newN0nc3ForS3cur1ty" style="height: 120px;" alt="">
            ...
            <div class="col-xxl-9">
                ...
                <div class="tab-content">
                                        ...
                                        <table class="table table-nowrap table-hover mb-1">
                                            <thead class="bg-light">
                                                <tr>
                                                    ...
                                                    <th scope="col"  nonce="newN0nc3ForS3cur1ty" style="width: 120px;">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="py-2">
                                    ...
                                    <div class="mx-n4 px-4" data-simplebar  nonce="newN0nc3ForS3cur1ty" style="max-height: 360px;">
                                        <div class="border-bottom pb-3">
                                            ...
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1">
                                                    <div class="d-flex">
                                                        <img src="{{ URL::asset('images/users/avatar-2.jpg') }}"
                    ...
                    <div class="tab-pane" id="post" role="tabpanel">
                        <div class="card">
                            <div class="card-body">
                                <div class="mx-n3 px-3" data-simplebar  nonce="newN0nc3ForS3cur1ty" style="max-height: 580px;">
                                    <div class="blog-post">
                                        ...
                                        <div class="position-relative mt-3">
                                            <img src="{{ URL::asset('images/post-1.jpg') }}" alt="" class="img-thumbnail">
                                        </div>
                                        <div class="pt-3">
                                            <div
                                                        ...
                                                        <div class="avatar-group">
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{ URL::asset('images/users/avatar-4.jpg') }}"
                                                                        alt="" class="rounded-circle avatar-sm">
                                                                </a>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                                <a href="javascript: void(0);" class="d-inline-block">
                                                                    <img src="{{ URL::asset('images/users/avatar-5.jpg') }}"
                                                                        alt="" class="rounded-circle avatar-sm">
                                                                </a>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="blog-post mt-3">
                                        ...
                                        <div class="position-relative mt-3">
                                            <img src="{{ URL::asset('images/post-2.jpg') }}" alt="" class="img-thumbnail">
                                        </div>
                                        <div class="pt-3">
                                            <div
                                                class="d-flex align-items-center justify-content-between border-bottom pb-3">
                    ...
                    <div class="card-body pt-1">
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap mb-0">
                                <tbody>
                                    <tr>
                                        <td  nonce="newN0nc3ForS3cur1ty" style="width: 50px;"><img src="{{ URL::asset('images/users/avatar-2.jpg') }}"
                                    ...
                                    <tr>
                                        <td><img src="{{ URL::asset('images/users/avatar-1.jpg') }}" class="rounded-circle avatar-sm"
                                                alt=""></td>
                                        <td>
                                            <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
                                    ...
                                    <tr>
                                        <td><img src="{{ URL::asset('images/users/avatar-4.jpg') }}" class="rounded-circle avatar-sm"
                                                alt=""></td>
                                        <td>
                                            <h5 class="font-size-14 m-0"><a href="javascript: void(0);"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-center g-0">
                            ...
                            <div class="col-sm-9">
                                <div class="progress mt-1"  nonce="newN0nc3ForS3cur1ty" style="height: 6px;">
                                    <div class="progress-bar progress-bar bg-primary" role="progressbar"
                                         nonce="newN0nc3ForS3cur1ty" style="width: 72%" aria-valuenow="52" aria-valuemin="0" aria-valuemax="52">
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end row-->
                        ...
                        <div class="row align-items-center g-0 mt-3">
                            ...
                            <div class="col-sm-9">
                                <div class="progress mt-1"  nonce="newN0nc3ForS3cur1ty" style="height: 6px;">
                                    <div class="progress-bar progress-bar bg-primary" role="progressbar"
                                         nonce="newN0nc3ForS3cur1ty" style="width: 45%" aria-valuenow="45" aria-valuemin="0" aria-valuemax="45">
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end row-->
                        ...
                        <div class="row align-items-center g-0 mt-3">
                            ...
                            <div class="col-sm-9">
                                <div class="progress mt-1"  nonce="newN0nc3ForS3cur1ty" style="height: 6px;">
                                    <div class="progress-bar progress-bar bg-primary" role="progressbar"
                                         nonce="newN0nc3ForS3cur1ty" style="width: 68%" aria-valuenow="48" aria-valuemin="0" aria-valuemax="48">
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end row-->
                        ...
                        <div class="row align-items-center g-0 mt-3">
                            ...
                            <div class="col-sm-9">
                                <div class="progress mt-1"  nonce="newN0nc3ForS3cur1ty" style="height: 6px;">
                                    <div class="progress-bar progress-bar bg-primary" role="progressbar"
                                         nonce="newN0nc3ForS3cur1ty" style="width: 78%" aria-valuenow="78" aria-valuemin="0" aria-valuemax="78">
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end row-->
                        ...
                        <div class="row align-items-center g-0 mt-3">
                            ...
                            <div class="col-sm-9">
                                <div class="progress mt-1"  nonce="newN0nc3ForS3cur1ty" style="height: 6px;">
                                    <div class="progress-bar progress-bar bg-primary" role="progressbar"
                                         nonce="newN0nc3ForS3cur1ty" style="width: 63%" aria-valuenow="63" aria-valuemin="0" aria-valuemax="63">
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end row-->
                        ...
                        <div class="row align-items-center g-0 mt-3">
                            ...
                            <div class="col-sm-9">
                                <div class="progress mt-1"  nonce="newN0nc3ForS3cur1ty" style="height: 6px;">
                                    <div class="progress-bar progress-bar bg-primary" role="progressbar"
                                         nonce="newN0nc3ForS3cur1ty" style="width: 48%" aria-valuenow="48" aria-valuemin="0" aria-valuemax="48">
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end row-->
