	...
	legendCallback: function(chart) {
		...
		if (datasets.length) {
			for (var i = 0; i < datasets[0].data.length; ++i) {
				text.push('<li><span  nonce="newN0nc3ForS3cur1ty" style="background-color:' + datasets[0].backgroundColor[i] + '"></span>');
				if (labels[i]) {
					text.push(labels[i]);
				}
				text.push('</li>');
...
function createResizer(handler) {
	...
	resizer.innerHTML =
		'<div class="' + cls + '-expand"  nonce="newN0nc3ForS3cur1ty" style="' + style + '">' +
			'<div  nonce="newN0nc3ForS3cur1ty" style="' +
				'position:absolute;' +
				'width:' + maxSize + 'px;' +
				'height:' + maxSize + 'px;' +
				'left:0;' +
			...
			'</div>' +
		'</div>' +
		'<div class="' + cls + '-shrink"  nonce="newN0nc3ForS3cur1ty" style="' + style + '">' +
			'<div  nonce="newN0nc3ForS3cur1ty" style="' +
				'position:absolute;' +
				'width:200%;' +
				'height:200%;' +
...
defaults._set('global', {
	...
	legendCallback: function(chart) {
		...
		for (var i = 0; i < chart.data.datasets.length; i++) {
			text.push('<li><span  nonce="newN0nc3ForS3cur1ty" style="background-color:' + chart.data.datasets[i].backgroundColor + '"></span>');
