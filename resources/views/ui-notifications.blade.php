...
@section('body')
                                ...
                                <div class="p-2">
                                    ...
                                    <div class="toast fade show" role="alert" aria-live="assertive"
                                        ...
                                        <div class="toast-header">
                                            <img src="{{ URL::asset('images/logo-dark-sm.png') }}" alt="" class="me-2"
                                                height="18">
                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    <div class="bg-light-subtle">
                                        <div aria-live="polite" aria-atomic="true" class="position-relative"
                                             nonce="newN0nc3ForS3cur1ty" style="min-height: 230px;">
                                            <!-- Position it: -->
                                            ...
                                            <div class="toast-container position-absolute top-0 end-0 p-2 p-lg-3">
                                                ...
                                                <div class="toast fade show" role="alert" aria-live="assertive"
                                                    data-bs-autohide="false" aria-atomic="true">
                                                    <div class="toast-header">
                                                        <img src="{{ URL::asset('images/logo-dark-sm.png') }}" alt=""
                                    ...
                                    <div class="bg-light-subtle p-2 p-lg-3">
                                        ...
                                        <div aria-live="polite" aria-atomic="true"
                                            class="d-flex justify-content-center align-items-center w-100"
                                             nonce="newN0nc3ForS3cur1ty" style="min-height: 200px;">
    ...
    @section('scripts')
        ...
        <!-- notification init -->
        <script src="{{ URL::asset('js/pages/notification.init.js') }}"></script>
        <!-- App js -->
