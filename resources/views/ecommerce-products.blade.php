...
@section('body')
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-md-6">
                                                    <div class="p-4 p-xl-0">
                                                        <img src="{{ URL::asset('images/product/img-8.png') }}"
                                                            class="img-fluid" alt="">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 col-sm-6">
                                            <div class="product-box rounded p-3 mt-4">
                                                ...
                                                <div class="product-img bg-light p-3 rounded">
                                                    <img src="{{ URL::asset('images/product/img-7.png') }}"
                                                        alt="" class="img-fluid mx-auto d-block">
                                                </div>
                                                <div class="product-content pt-3">
                                                    <p class="text-muted font-size-13 mb-0">Chair</p>
                                        ...
                                        <div class="col-xl-4 col-sm-6">
                                            <div class="product-box rounded p-3 mt-4">
                                                ...
                                                <div class="product-img bg-light p-3 rounded">
                                                    <img src="{{ URL::asset('images/product/img-9.png') }}"
                                                        alt="" class="img-fluid mx-auto d-block">
                                                </div>
                                                <div class="product-content pt-3">
                                                    <p class="text-muted font-size-13 mb-0">Gray, Chair</p>
    ...
    @section('scripts')
        ...
        <!-- init js -->
        <script src="{{ URL::asset('js/pages/product-filter-range.init.js') }}"></script>
        <!-- App js -->
