...
@section('body')
                                ...
                                <div class="product-detail mt-3" dir="ltr">
                                    ...
                                    <div
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide rounded">
                                                <div class="p-3">
                                                    <div class="product-img bg-light rounded p-3">
                                                        <img src="{{ URL::asset('images/product/img-6.png') }}"
                                                            class="img-fluid d-block" />
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="mt-4">
                                        <div thumbsSlider="" class="swiper product-nav-slider mt-2 overflow-hidden">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide rounded">
                                                    <div class="nav-slide-item"><img src="{{ URL::asset('images/product/img-1.png') }}"
                                                            class="img-fluid p-1 d-block rounded" /></div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="nav-slide-item"><img src="{{ URL::asset('images/product/img-2.png') }}"
                                                            class="img-fluid p-1 d-block rounded" /></div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="nav-slide-item"><img src="{{ URL::asset('images/product/img-3.png') }}"
                                                            class="img-fluid p-1 d-block rounded" /></div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="nav-slide-item"><img src="{{ URL::asset('images/product/img-6.png') }}"
                                                            class="img-fluid p-1 d-block rounded" /></div>
                                                </div>
                                                <div class="swiper-slide">
                                                    <div class="nav-slide-item"><img src="{{ URL::asset('images/product/img-5.png') }}"
                                                            class="img-fluid p-1 d-block rounded" /></div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-8">
                                <div class="">
                                    ...
                                    <div class="border py-4 rounded">
                                        ...
                                        <div class="px-4" data-simplebar  nonce="newN0nc3ForS3cur1ty" style="max-height: 360px;">
                                        ...
                                        <div class="tab-pane fade show active" id="specifi" role="tabpanel">
                                            <div class="table-responsive">
                                                <table class="table table-nowrap mb-0">
                                                    <tbody>
                                                        <tr>
                                                            <th scope="row"  nonce="newN0nc3ForS3cur1ty" style="width: 50%;">Category :</th>
                                                            <td> Chairs </td>
                                                        </tr>
                                                        <tr>
    ...
    @section('scripts')
        ...
        <script src="{{ URL::asset('js/pages/ecommerce-product-detail.init.js') }}"></script>
        <!-- App js -->
