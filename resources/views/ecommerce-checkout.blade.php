                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle mb-0 table-nowrap">
                                <thead>
                                    <tr>
                                        <th class="border-top-0"  nonce="newN0nc3ForS3cur1ty" style="width: 90px;" scope="col">Product</th>
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row"><img src="{{ URL::asset('images/product/img-1.png') }}" alt="product-img"
                                    ...
                                    <tr>
                                        <th scope="row"><img src="{{ URL::asset('images/product/img-2.png') }}" alt="product-img"
                                                title="product-img" class="avatar-md"></th>
                                        <td>
                                            <h5 class="font-size-15 text-truncate"><a href="ecommerce-product-detail"
