...
@section('body')
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mt-4 px-1 pt-1">
                            <div class="mx-n4" data-simplebar  nonce="newN0nc3ForS3cur1ty" style="max-height: 214px;">
            ...
            <div class="col-xl-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mx-n4" data-simplebar  nonce="newN0nc3ForS3cur1ty" style="max-height: 390px;">
            ...
            <div class="col-xl-4">
                <div class="card">
                    ...
                    <div class="small-chat">
                        <div class="chat-conversation p-3" data-simplebar  nonce="newN0nc3ForS3cur1ty" style="max-height: 316px;">
                                                        ...
                                                        <ul class="list-inline message-img mt-2 mb-0">
                                                            <li class="list-inline-item message-img-list">
                                                                <a class="d-inline-block" href="">
                                                                    <img src="{{ URL::asset('images/small/img-1.jpg') }}"
                                                            ...
                                                            <li class="list-inline-item message-img-list">
                                                                <a class="d-inline-block" href="">
                                                                    <img src="{{ URL::asset('images/small/img-2.jpg') }}"
                                                                        alt="" class="rounded img-thumbnail">
                                                                </a>
                                                            </li>
                                                        </ul>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-centered align-middle table-nowrap mb-0 table-check">
                                <thead>
                                    <tr>
                                        <th  nonce="newN0nc3ForS3cur1ty" style="width: 90px;">
                                            Product
                                        </th>
                                        <th  nonce="newN0nc3ForS3cur1ty" style="width: 210px;">Product Name</th>
                                        <th>Customer Name</th>
                                        <th>Order ID</th>
                                        <th>Color</th>
                                        <th>Date</th>
                                        <th>Status</th>
                                        <th  nonce="newN0nc3ForS3cur1ty" style="width: 270px;">Trend</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <td>
                                            <div class="avatar">
                                                <div
                                                    ...
                                                    <img src="{{ URL::asset('images/product/img-1.png') }}"
                                                        class="img-fluid" alt="">
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="avatar">
                                                <div
                                                    ...
                                                    <img src="{{ URL::asset('images/product/img-2.png') }}"
                                                        class="img-fluid" alt="">
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="avatar">
                                                <div
                                                    ...
                                                    <img src="{{ URL::asset('images/product/img-3.png') }}"
                                                        class="img-fluid" alt="">
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="avatar">
                                                <div
                                                    class="product-img avatar-title img-thumbnail bg-primary-subtle border-0">
                                                    <img src="{{ URL::asset('images/product/img-4.png') }}"
                                                        class="img-fluid" alt="">
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="avatar">
                                                <div
                                                    class="product-img avatar-title img-thumbnail bg-success-subtle border-0">
                                                    <img src="{{ URL::asset('images/product/img-5.png') }}"
                                                        class="img-fluid" alt="">
                                                </div>
                                            </div>
                                        </td>
    ...
    @section('scripts')
        ...
        <script src="{{ URL::asset('js/pages/dashboard-sales.init.js') }}"></script>
