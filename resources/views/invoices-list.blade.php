...
@section('css')
    <!-- gridjs css -->
    <link rel="stylesheet" href="{{ URL::asset('libs/gridjs/theme/mermaid.min.css') }}">

    <!-- flatpickr css -->
    <link href="{{ URL::asset('libs/flatpickr/flatpickr.min.css') }}" rel="stylesheet" type="text/css">
@endsection
@section('page-title')
    Invoice List
@endsection
@section('body')
    ...
    @section('scripts')
        ...
        <!-- invoice-list init -->
        <script src="{{ URL::asset('js/pages/invoice-list.init.js') }}"></script>
        <!-- App js -->
