...
@section('title', 'ARTEMIGA - Beneficios')
...
@section('body')
    ...
    @section('content')
        ...
        <div class="dashboard-container mt-5">
            <div class="dashboard-content mt-3">
                <div class="artemiga-container">
                    <!-- Header con flecha de regreso -->
                    <div class="artemiga-header">
                    ...
                    <!-- Imagen principal -->
                    <img src="{{ asset('images/sponsors/ARTEMIGA.png') }}" alt="ARTEMIGA" class="artemiga-main-image"
                        draggable="false" />
                    ...
                    <div class="discount-card">
                        ...
                        <div class="discount-description">En pan dulce, sándwiches, jugos y café</div>
                    </div>
    ...
    @push('styles')
        <link rel="stylesheet" href="{{ asset('css/artemiga.css') }}">
    @endpush
    ...
    @push('scripts')
        ...
        <script nonce="newN0nc3ForS3cur1ty">
            // Inicializar página ARTEMIGA
            document.addEventListener('DOMContentLoaded', function() {
                initArtemigaPage();
            });

            function initArtemigaPage() {
                ...
                // Iniciar animaciones
                startArtemigaAnimations();
            }

            function startArtemigaAnimations() {
                // Las animaciones se activan automáticamente con CSS
                // console.log('ARTEMIGA page animations started');
            }
