                ...
                <div class="card-body">
                    ...
                    <div class="text-center bg-light rounded px-4 py-3">
                        ...
                        <div class="chat-user-status">
                            <img src="{{ URL::asset('images/users/avatar-3.jpg') }}" class="avatar-md rounded-circle" alt="">
                            <div class="">
                                <div class="status"></div>
                            </div>
                        </div>
                        <h5 class="font-size-16 mb-1 mt-3"><a href="#" class="text-reset">Martin Gurley </a></h5>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <h5 class="font-size-16 mb-1 text-truncate"><a href="#"
                                                class="text-reset">Jennie Sherlock</a></h5>
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li>
                                <div class="conversation-list">
                                    <div class="d-flex">
                                        <img src="{{ URL::asset('images/users/avatar-6.jpg') }}" class="rounded-circle avatar"
                                            alt="">
                                        <div class="flex-1">
                            ...
                            <li class="right">
                                <div class="conversation-list">
                                    <div class="d-flex">
                                        ...
                                        <img src="{{ URL::asset('images/users/avatar-3.jpg') }}" class="rounded-circle avatar"
                                            alt="">
                                    </div>
