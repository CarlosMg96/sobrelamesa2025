...
@section('body')
    ...
    @section('content')
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="mb-3">
                    <h5 class="card-title">@lang('Propuestas de Servicios')
            ...
            <div class="col-md-6">
                <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3 mt-1">
                    ...
                    <div>
                        @can('create travels')     
                        <a href="{{ route('service.proposals.create') }}" class="btn btn-warning text-black">
                            <i class="bx bx-plus me-1"></i>@lang('Nuevo')</a>
                        @endcan
                    </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-nowrap align-middle" id="table">
                                ...
                                <tbody>
                                    @forelse (App\Models\ServiceProposal::all() as $item)
                                    <tr>
