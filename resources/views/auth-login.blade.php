                        ...
                        <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="mb-4 pb-2">
                                <a href="{{ route('dashboard') }}" class="d-block auth-logo">
                                    <img src="{{ URL::asset('images/logo-dark.png') }}" alt="" height="30"
                                        class="auth-logo-dark me-start">
                                    <img src="{{ URL::asset('images/logo-light.png') }}" alt="" height="30"
                        ...
                        <div class="col-lg-12">
                            <div class="text-center p-4">
                                <p>©
                                    ...
                                    </script> Galicia. Crafted with <i
                                        class="mdi mdi-heart text-danger"></i> by <a href="https://sodio.net/" target="_blank" class="text-reset">Sodio</a>
                                </p>
                            </div>
                        </div>
                    </div>
