        ...
        <div id="floor-contentZoom" class="position-relative w-100 level-floor-content">
            <div class="svg-zoom-container level-svg-container">
                <div class="svg-container" id="svgContainer">
                    <object id="planoPiso25" data="{{ URL::asset('images/svgMaps/Piso_23_21Ago25_6pm.svg?v=1') }}"
...
@push('scripts')
    ...
    <script nonce="newN0nc3ForS3cur1ty" >
        ...
        // Pasar los usuarios agrupados por sección al contexto de JavaScript
        ...
        if (typeof window.seccionesPiso25 === 'undefined') {
            window.seccionesPiso25 = [];
        }

        // Configuración de las áreas del mapa
        window.seccionesPiso23 = window.seccionesPiso23.concat([{
                id: 'p23-1',
                code: 'A1',
            ...
            },
            {
                id: 'p23-61',
                code: 'A61',
                nombre: 'Archivo de alta densidad',
                icono: ''
            },
            {
                id: 'p23-62',
                code: 'A62',
                nombre: 'Service Lobby',
                icono: ''
            },
            {
                id: 'p23-63',
            ...
            },
{
        ...
        function loadAndInitializeSVG() {
            ...
            const svgObject = document.getElementById('planoPiso25');
            ...
            svgObject.addEventListener('load', function() {
                ...
                if (typeof window.seccionesPiso25 !== 'undefined' && Array.isArray(window.seccionesPiso25)) {
                    // console.log('Inicializando secciones desde seccionesPiso25. Total:', window.seccionesPiso25
                        // .length);
                    window.secciones = [...window.seccionesPiso25];
                    ...
                    // console.error('No se encontraron secciones en window.seccionesPiso25');
                }
            });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setTimeout(() => {
                if (typeof window.seccionesPiso25 !== 'undefined' && Array.isArray(window
                        .seccionesPiso25)) {
                    window.secciones = [...window.seccionesPiso25];
                    if (typeof window.cargarSecciones === 'function') {
                        window.cargarSecciones();
        ...
        function setupAreaClickHandlers(svgDocument, retryCount = 0) {
            ...
            // Asegurarse de que seccionesPiso25 existe
            if (!window.seccionesPiso25 || !Array.isArray(window.seccionesPiso25)) {
                console.error('seccionesPiso25 no está definido o no es un array');
                return;
            }

            window.seccionesPiso25.forEach(section => {
        ...
        function initMapAreas(svgDocument) {
            ...
            seccionesPiso25.forEach(section => {
                const area = svgDocument.getElementById(section.id);
                if (area) {
        ...
        window.resaltarArea = function(areaId, retryCount = 0, showModal = true) {
            ...
            try {
                ...
                const areas = svgDoc.querySelectorAll('[id^="p25-"]');
                areas.forEach(a => {
                    if (a.classList) {
                ...
                const seccion = window.seccionesPiso25 ? window.seccionesPiso25.find(s => s.id === areaId) : null;
