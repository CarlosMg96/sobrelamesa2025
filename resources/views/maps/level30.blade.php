        ...
        <div id="floor-contentZoom" class="position-relative w-100 level-floor-content">
            <div class="svg-zoom-container level-svg-container">
                <div class="svg-container" id="svgContainer">
                    <object id="planoPiso30" data="{{ URL::asset('images/svgMaps/Piso_30_(22Ago25_12pm).svg?v=1') }}"
...
@push('scripts')
    ...
    <script nonce="newN0nc3ForS3cur1ty" >
        ...
        if (typeof window.seccionesPiso30 === 'undefined') {
            window.seccionesPiso30 = [];
        }

        // Configuración de las áreas del mapa
        window.seccionesPiso30 = window.seccionesPiso30.concat([{
                id: 'p30-1',
                code: 'A1',
        ...
        function loadAndInitializeSVG() {
            ...
            const svgObject = document.getElementById('planoPiso30');
            ...
            svgObject.addEventListener('load', function() {
                ...
                if (typeof window.seccionesPiso30 !== 'undefined' && Array.isArray(window.seccionesPiso30)) {
                    // console.log('Inicializando secciones desde seccionesPiso30. Total:', window.seccionesPiso30
                        // .length);
                    window.secciones = [...window.seccionesPiso30];
                    ...
                    console.error('No se encontraron secciones en window.seccionesPiso30');
                }
            });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setTimeout(() => {
                if (typeof window.seccionesPiso30 !== 'undefined' && Array.isArray(window
                        .seccionesPiso30)) {
                    window.secciones = [...window.seccionesPiso30];
                    if (typeof window.cargarSecciones === 'function') {
                        window.cargarSecciones();
        ...
        function setupAreaClickHandlers(svgDocument, retryCount = 0) {
            ...
            // Asegurarse de que seccionesPiso30 existe
            if (!window.seccionesPiso30 || !Array.isArray(window.seccionesPiso30)) {
                console.error('seccionesPiso30 no está definido o no es un array');
                return;
            }

            window.seccionesPiso30.forEach(section => {
        ...
        function initMapAreas(svgDocument) {
            ...
            seccionesPiso30.forEach(section => {
                const area = svgDocument.getElementById(section.id);
                if (area) {
        ...
        window.resaltarArea = function(areaId, retryCount = 0, showModal = true) {
            ...
            try {
                ...
                const areas = svgDoc.querySelectorAll('[id^="p30-"]');
                areas.forEach(a => {
                    if (a.classList) {
                ...
                const seccion = window.seccionesPiso30 ? window.seccionesPiso30.find(s => s.id === areaId) : null;
