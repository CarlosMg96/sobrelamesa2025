        ...
        <div id="floor-contentZoom" class="position-relative w-100 level-floor-content">
            <div class="svg-zoom-container level-svg-container">
                <div class="svg-container" id="svgContainer">
                    <object id="planoPiso29" data="{{ URL::asset('images/svgMaps/Piso_29_(22Ago25_12pm).svg?v=1') }}"
...
@push('scripts')
    ...
    <script nonce="newN0nc3ForS3cur1ty" >
        ...
        if (typeof window.seccionesPiso29 === 'undefined') {
            window.seccionesPiso29 = [];
        }

        // Configuración de las áreas del mapa
        window.seccionesPiso29 = window.seccionesPiso29.concat([{
                id: 'p29-1',
                code: 'A1',
        ...
        function loadAndInitializeSVG() {
            ...
            const svgObject = document.getElementById('planoPiso29');
            ...
            svgObject.addEventListener('load', function() {
                ...
                if (typeof window.seccionesPiso29 !== 'undefined' && Array.isArray(window.seccionesPiso29)) {
                    // console.log('Inicializando secciones desde seccionesPiso29. Total:', window.seccionesPiso29
                        // .length);
                    window.secciones = [...window.seccionesPiso29];
                    ...
                    console.error('No se encontraron secciones en window.seccionesPiso29');
                }
            });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setTimeout(() => {
                if (typeof window.seccionesPiso29 !== 'undefined' && Array.isArray(window
                        .seccionesPiso29)) {
                    window.secciones = [...window.seccionesPiso29];
                    if (typeof window.cargarSecciones === 'function') {
                        window.cargarSecciones();
        ...
        function setupAreaClickHandlers(svgDocument, retryCount = 0) {
            ...
            // Asegurarse de que seccionesPiso29 existe
            if (!window.seccionesPiso29 || !Array.isArray(window.seccionesPiso29)) {
                console.error('seccionesPiso29 no está definido o no es un array');
                return;
            }

            window.seccionesPiso29.forEach(section => {
        ...
        function initMapAreas(svgDocument) {
            ...
            seccionesPiso29.forEach(section => {
                const area = svgDocument.getElementById(section.id);
                if (area) {
        ...
        window.resaltarArea = function(areaId, retryCount = 0, showModal = true) {
            ...
            try {
                ...
                const areas = svgDoc.querySelectorAll('[id^="p29-"]');
                areas.forEach(a => {
                    if (a.classList) {
                ...
                const seccion = window.seccionesPiso29 ? window.seccionesPiso29.find(s => s.id === areaId) : null;
