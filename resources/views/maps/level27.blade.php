        ...
        <div id="floor-contentZoom" class="position-relative w-100 level-floor-content">
            <div class="svg-zoom-container level-svg-container">
                <div class="svg-container" id="svgContainer">
                    <object id="planoPiso27" data="{{ URL::asset('images/svgMaps/Piso_27_(22Ago25_12pm).svg?v=1') }}"
...
@push('scripts')
    ...
    <script nonce="newN0nc3ForS3cur1ty" >
        ...
        if (typeof window.seccionesPiso27 === 'undefined') {
            window.seccionesPiso27 = [];
        }

        // Configuración de las áreas del mapa
        window.seccionesPiso27 = window.seccionesPiso27.concat([{
                id: 'p27-1',
                code: 'A1',
        ...
        function loadAndInitializeSVG() {
            ...
            const svgObject = document.getElementById('planoPiso27');
            ...
            svgObject.addEventListener('load', function() {
                ...
                if (typeof window.seccionesPiso27 !== 'undefined' && Array.isArray(window.seccionesPiso27)) {
                    // console.log('Inicializando secciones desde seccionesPiso27. Total:', window.seccionesPiso27
                    //     .length);
                    window.secciones = [...window.seccionesPiso27];
                    ...
                    console.error('No se encontraron secciones en window.seccionesPiso27');
                }
            });
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            setTimeout(() => {
                if (typeof window.seccionesPiso27 !== 'undefined' && Array.isArray(window
                        .seccionesPiso27)) {
                    window.secciones = [...window.seccionesPiso27];
                    if (typeof window.cargarSecciones === 'function') {
                        window.cargarSecciones();
        ...
        function setupAreaClickHandlers(svgDocument, retryCount = 0) {
            ...
            // Asegurarse de que seccionesPiso27 existe
            if (!window.seccionesPiso27 || !Array.isArray(window.seccionesPiso27)) {
                console.error('seccionesPiso27 no está definido o no es un array');
                return;
            }

            window.seccionesPiso27.forEach(section => {
        ...
        function initMapAreas(svgDocument) {
            ...
            seccionesPiso27.forEach(section => {
                const area = svgDocument.getElementById(section.id);
                if (area) {
        ...
        window.resaltarArea = function(areaId, retryCount = 0, showModal = true) {
            ...
            try {
                ...
                const areas = svgDoc.querySelectorAll('[id^="p27-"]');
                areas.forEach(a => {
                    if (a.classList) {
                ...
                const seccion = window.seccionesPiso27 ? window.seccionesPiso27.find(s => s.id === areaId) : null;
