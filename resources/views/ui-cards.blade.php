            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="row g-0 align-items-center">
                        <div class="col-md-4">
                            <img class="card-img img-fluid" src="{{ URL::asset('images/small/img-2.jpg') }}" alt="Card image">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="row g-0 align-items-center">
                        ...
                        <div class="col-md-4">
                            <img class="card-img img-fluid" src="{{ URL::asset('images/small/img-3.jpg') }}" alt="Card image">
                        </div>
                    </div>
                </div>
            </div><!-- end col -->
            ...
            <div class="col-sm-12">
                ...
                <div class="row" data-masonry='{"percentPosition": true }'>
                    <div class="col-sm-6 col-lg-4">
                        <div class="card">
                            <img src="{{ URL::asset('images/small/img-3.jpg') }}" class="card-img-top" alt="...">
                            <div class="card-body">
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card">
                            <img src="{{ URL::asset('images/small/img-5.jpg') }}" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="card">
                            <img src="{{ URL::asset('images/small/img-7.jpg') }}" class="card-img-top" alt="...">
                        </div>
                    </div><!-- end col -->
