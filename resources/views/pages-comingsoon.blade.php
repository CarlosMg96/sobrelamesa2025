...
@section('body')
    ...
    @section('content')
        ...
        <div class="authentication-bg min-vh-100"  nonce="newN0nc3ForS3cur1ty" style="background: url(images/bg-1.png);">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <a href="index" class="d-block auth-logo">
                                <img src="{{ URL::asset('images/logo-dark.png') }}" alt="" height="36"
                                    class="auth-logo-dark mx-auto">
                                <img src="{{ URL::asset('images/logo-light.png') }}" alt="" height="36"
                                    class="auth-logo-light mx-auto">
                            </a>
                            <div class="row justify-content-center mt-5">
                                <div class="col-sm-6">
                                    <div class="maintenance-img">
                                        <img src="{{ URL::asset('images/coming-soon.png') }}" alt=""
