                    ...
                    <div class="card-body">
                        <div>
                            ...
                            <div class="bg-light-subtle p-3 text-center">
                                <div class="row align-items-start"  nonce="newN0nc3ForS3cur1ty" style="min-height: 6rem;">
                                    <div class="col-sm-4">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="bg-light-subtle p-3 text-center">
                                <div class="row align-items-center"  nonce="newN0nc3ForS3cur1ty" style="min-height: 6rem;">
                                    <div class="col-sm-4">
                                        <div class="grid-example">
                                            <code>col-sm-4</code>
                                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="bg-light-subtle p-3 text-center">
                                <div class="row align-items-end"  nonce="newN0nc3ForS3cur1ty" style="min-height: 6rem;">
                                    <div class="col-sm-4">
                                        <div class="grid-example">
                                            <code>col-sm-4</code>
                                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="bg-light-subtle p-3 text-center">
                                <div class="row"  nonce="newN0nc3ForS3cur1ty" style="min-height: 9rem;">
