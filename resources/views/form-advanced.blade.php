...
@section('css')
    <!-- choices css -->
    <link href="{{ URL::asset('libs/choices.js/public/assets/styles/choices.min.css') }}" rel="stylesheet" type="text/css" />

    <!-- color picker css -->
    <link rel="stylesheet" href="{{ URL::asset('libs/@simonwep/pickr/themes/classic.min.css') }}" /> <!-- 'classic' theme -->
    <link rel="stylesheet" href="{{ URL::asset('libs/@simonwep/pickr/themes/monolith.min.css') }}" /> <!-- 'monolith' theme -->
    <link rel="stylesheet" href="{{ URL::asset('libs/@simonwep/pickr/themes/nano.min.css') }}" /> <!-- 'nano' theme -->
...
@section('body')
    ...
    @section('scripts')
        <!-- choices js -->
        <script src="{{ URL::asset('libs/choices.js/public/assets/scripts/choices.min.js') }}"></script>

        <!-- color picker js -->
        <script src="{{ URL::asset('libs/@simonwep/pickr/pickr.min.js') }}"></script>
        <script src="{{ URL::asset('libs/@simonwep/pickr/pickr.es5.min.js') }}"></script>
