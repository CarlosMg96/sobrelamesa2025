                ...
                <div class="card">
                    <div class="card-body">
                        <div class="invoice-title">
                            ...
                            <div class="mb-4">
                                <img src="{{ URL::asset('images/logo-dark-sm.png') }}" alt="logo" height="34" />
                            </div>
                        ...
                        <div class="py-2">
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap table-centered mb-0">
                                    <thead>
                                        <tr>
                                            <th class="fw-bold"  nonce="newN0nc3ForS3cur1ty" style="width: 70px;">No.</th>
                                            <th class="fw-bold">Item</th>
                                            <th class="fw-bold">Price</th>
                                            <th class="fw-bold">Quantity</th>
                                            <th class="text-end fw-bold"  nonce="newN0nc3ForS3cur1ty" style="width: 120px;">Total</th>
                                        </tr>
                                    </thead><!-- end thead -->
                                    <tbody>
                                        <tr>
