...
@section('body')
                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="mt-4 pt-3 mt-auto text-center">
                                    <div class="card mb-0">
                                        <div class="card-body">
                                            <div class="px-4">
                                                <img src="{{ URL::asset('images/Upgrade-img.png') }}" class="img-fluid" alt="">
                                            </div>
                    ...
                    <div class="w-100">
                        <div class="card">
                            <div class="card-body">
                                                    ...
                                                    <div class="d-flex align-items-center overflow-hidden">
                                                        ...
                                                        <div class="flex-shrink-0 me-3">
                                                            <div class="avatar align-self-center">
                                                                <div
                                                                    class="avatar-title rounded bg-primary-subtle text-primary font-size-24">
                                                    ...
                                                    <div class="mt-3 pt-1">
                                                        ...
                                                        <div class="progress animated-progess custom-progress">
                                                            <div class="progress-bar bg-gradient bg-primary"
                                                                role="progressbar"  nonce="newN0nc3ForS3cur1ty" style="width: 90%" aria-valuenow="90"
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="d-flex align-items-center overflow-hidden">
                                                        ...
                                                        <div class="flex-shrink-0 me-3">
                                                            <div class="avatar align-self-center">
                                                                <div
                                                                    class="avatar-title rounded bg-info-subtle text-info font-size-24">
                                            ...
                                            <div class="card-body p-3">
                                                <div class="">
                                                    ...
                                                    <div class="mt-3 pt-1">
                                                        ...
                                                        <div class="progress animated-progess custom-progress">
                                                            <div class="progress-bar bg-gradient bg-primary"
                                                                role="progressbar"  nonce="newN0nc3ForS3cur1ty" style="width: 70%" aria-valuenow="70"
                                ...
                                <div class="mx-n4 mt-4" data-simplebar  nonce="newN0nc3ForS3cur1ty" style="max-height: 350px;">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table align-middle table-nowrap table-hover mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><a href="javascript: void(0);" class="text-body fw-medium"><i
                                ...
                                <div class="pb-2 mb-2">
                                    <a href="javascript: void(0);" class="text-body">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar align-self-center me-3">
                                                <div
                                                    class="avatar-title rounded bg-success-subtle text-success font-size-24">
                                ...
                                <div class="py-2 mb-2">
                                    <a href="javascript: void(0);" class="text-body">
                                        <div class="d-flex align-items-center">
                                            <div class="avatar align-self-center me-3">
                                                <div
                                                    class="avatar-title rounded bg-warning-subtle text-warning font-size-24">
    ...
    @section('scripts')
        ...
        <!-- file-manager js -->
        <script src="{{ URL::asset('js/pages/file-manager.init.js') }}"></script>
        <!-- App js -->
