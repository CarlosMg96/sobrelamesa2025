                    ...
                    <div class="col-xl-7">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-5">
                                        <div class="popular-product-img p-2">
                                            <img src="{{ URL::asset('images/product/img.png') }}" alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                ...
                                <div class="mx-n4" data-simplebar  nonce="newN0nc3ForS3cur1ty" style="max-height: 205px;">
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="avatar-md">
                                                    <div
                                                        ...
                                                        <img src="{{ URL::asset('images/product/img-1.png') }}" class="img-fluid"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="avatar-md">
                                                    <div
                                                        ...
                                                        <img src="{{ URL::asset('images/product/img-8.png') }}" class="img-fluid"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex-shrink-0">
                                                <div class="avatar-md">
                                                    <div
                                                        ...
                                                        <img src="{{ URL::asset('images/product/img-3.png') }}" class="img-fluid"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <div class="avatar-md">
                                                    <div
                                                        class="product-img avatar-title img-thumbnail bg-success-subtle border-0">
                                                        <img src="{{ URL::asset('images/product/img-4.png') }}" class="img-fluid"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0">
                                                <div class="avatar-md">
                                                    <div
                                                        class="product-img avatar-title img-thumbnail bg-danger-subtle border-0">
                                                        <img src="{{ URL::asset('images/product/img-5.png') }}" class="img-fluid"
                                                            alt="">
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="col-xl-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mx-n4" data-simplebar  nonce="newN0nc3ForS3cur1ty" style="max-height: 421px;">
                                    ...
                                    <div class="border-bottom loyal-customers-box">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ URL::asset('images/users/avatar-7.jpg') }}"
                                                class="rounded-circle avatar img-thumbnail" alt="">
                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                                    ...
                                    <div class="border-bottom loyal-customers-box">
                                        <div class="d-flex align-items-center">
                                            <img src="{{ URL::asset('images/users/avatar-8.jpg') }}"
                                                class="rounded-circle avatar img-thumbnail" alt="">
                                            <div class="flex-grow-1 ms-3 overflow-hidden">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center">
                            <div class="col-xxl-7">
                                <div class="py-3">
                                    <div id="world-map-markers"  nonce="newN0nc3ForS3cur1ty" style="height: 300px"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-5">
                                <div class="table-responsive">
                                    <table class="table table-centered align-middle table-nowrap mb-0">
                                        <thead>
                                            <tr>
                                                <th  nonce="newN0nc3ForS3cur1ty" style="width: 500px;">Countries</th>
                                                <th>Orders</th>
                                                <th>Earnings</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{ URL::asset('#') }}" class="rounded"
            ...
            <div class="col-xxl-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mx-n4" data-simplebar  nonce="newN0nc3ForS3cur1ty" style="max-height: 332px;">
                            <div class="table-responsive">
                                <table
                                    class="table table-striped table-centered align-middle table-nowrap mb-0 table-check">
                                    <thead>
                                        <tr>
                                            <th  nonce="newN0nc3ForS3cur1ty" style="width: 30px;">
                                            ...
                                            <th>#Invoice</th>
                                            <th  nonce="newN0nc3ForS3cur1ty" style="width: 190px;">User Name</th>
                                            <th>Date</th>
                                            <th>Status</th>
                                            <th>Action</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td  nonce="newN0nc3ForS3cur1ty" style="width: 190px;">
                                                <div class="d-flex align-items-center">
                                                    <img class="rounded-circle avatar-sm"
                                                        src="{{ URL::asset('images/users/avatar-1.jpg') }}" alt="">
                                                    <div class="flex-grow-1 ms-3">
                                                        Neal Matthews
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td  nonce="newN0nc3ForS3cur1ty" style="width: 190px;">
                                                <div class="d-flex align-items-center">
                                                    <img class="rounded-circle avatar-sm"
                                                        src="{{ URL::asset('images/users/avatar-2.jpg') }}" alt="">
                                                    <div class="flex-grow-1 ms-3">
                                                        Connie Franco
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td  nonce="newN0nc3ForS3cur1ty" style="width: 190px;">
                                                <div class="d-flex align-items-center">
                                                    <img class="rounded-circle avatar-sm"
                                                        src="{{ URL::asset('images/users/avatar-3.jpg') }}" alt="">
                                                    <div class="flex-grow-1 ms-3">
                                                        Adella Perez
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td  nonce="newN0nc3ForS3cur1ty" style="width: 190px;">
                                                <div class="d-flex align-items-center">
                                                    <img class="rounded-circle avatar-sm"
                                                        src="{{ URL::asset('images/users/avatar-4.jpg') }}" alt="">
                                                    <div class="flex-grow-1 ms-3">
                                                        Theresa Mayers
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td  nonce="newN0nc3ForS3cur1ty" style="width: 190px;">
                                                <div class="d-flex align-items-center">
                                                    <img class="rounded-circle avatar-sm"
                                                        src="{{ URL::asset('images/users/avatar-5.jpg') }}" alt="">
                                                    <div class="flex-grow-1 ms-3">
                                                        Oliver Gonzales
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td  nonce="newN0nc3ForS3cur1ty" style="width: 190px;">
                                                <div class="d-flex align-items-center">
                                                    <img class="rounded-circle avatar-sm"
                                                        src="{{ URL::asset('images/users/avatar-6.jpg') }}" alt="">
                                                    <div class="flex-grow-1 ms-3">
                                                        Willie Verner
                                                    </div>
                                                </div>
