...
@section('css')
    <!-- tui charts Css -->
    <link href="{{ URL::asset('libs/tui-chart/tui-chart.min.css') }}" rel="stylesheet" type="text/css" />
@endsection
@section('page-title')
    Toast UI Charts
@endsection
@section('body')
    ...
    @section('scripts')
        <!-- tui charts plugins -->
        <script src="{{ URL::asset('libs/tui-chart/tui-chart-all.min.js') }}"></script>

        <!-- tui charts map -->
        <script src="{{ URL::asset('libs/tui-chart/maps/usa.js') }}"></script>

        <!-- tui charts plugins -->
        <script src="{{ URL::asset('js/pages/tui-charts.init.js') }}"></script>
        <!-- App js -->
